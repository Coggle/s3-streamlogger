...
### Define custom object key
```js
var S3StreamLogger = require('s3-streamlogger').S3StreamLogger;

var s3stream = new S3StreamLogger({
             bucket: "mys3bucket",
             object_name_creator: function() {
               return "/2017/09/07/" + uuid();
             },
      access_key_id: "...",
  secret_access_key: "..."
});
...
#### object_name_creator
Function which should return as string S3 path with filename so basicly full s3 key in the bucket.
